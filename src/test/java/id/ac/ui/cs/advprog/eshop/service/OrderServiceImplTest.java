...
class OrderServiceImplTest {
    ...
    void setUp() {
        ...
        product1.setProductId("asdfklahsdflkasjdf");
        product1.setProductName("Sampo Cap Bambang");
        product1.setProductQuantity(2);
        products.add(product1);

        orders = new ArrayList<>();
        Order order1 = new Order("1234354325235", products, 21342134L, "Safira Sudrajat");
        orders.add(order1);
        Order order2 = new Order("12343132454325235", products, 21342134L, "Safira Sudrajat");
        orders.add(order2);
    }
